...
class EffectiveMuError(LilithError):
    """Exception class in case of error when computing effective signal strengths."""

class PriorError(LilithError):
    """Exception class in case of error when evaluating priors."""
